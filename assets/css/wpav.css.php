...
/* Site logo and title */
$css_styles .= '.quicklinks li.wpav_site_title {';
...
$css_styles .= '}';
$css_styles .= '.quicklinks li.wpav_site_title a{outline:none; border:none;}';
...
$css_styles .= '.quicklinks li.wpav_site_title a, .quicklinks li.wpav_site_title a:hover, .quicklinks li.wpav_site_title a:focus {';
